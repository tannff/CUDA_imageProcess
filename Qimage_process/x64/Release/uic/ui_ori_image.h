...
public:
    ...
    void setupUi(QWidget *ori_imageClass)
    {
        ...
        ori_imageClass->resize(883, 464);
        QIcon icon;
        icon.addFile(QString::fromUtf8("a6avc-bfprc-001.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ori_imageClass->setWindowIcon(icon);
        label = new QLabel(ori_imageClass);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(30, 20, 481, 401));
        horizontalLayoutWidget_4 = new QWidget(ori_imageClass);
        horizontalLayoutWidget_4->setObjectName(QString::fromUtf8("horizontalLayoutWidget_4"));
        horizontalLayoutWidget_4->setGeometry(QRect(560, 60, 261, 32));
        ...
        label_10->setGeometry(QRect(680, 169, 91, 21));
        ...
        label_9->setGeometry(QRect(560, 158, 80, 31));
        ...
        pushButton->setGeometry(QRect(560, 360, 261, 31));
        label_2 = new QLabel(ori_imageClass);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(540, 20, 311, 391));
        ...
        label_14->setGeometry(QRect(650, 209, 61, 31));
        ...
        label_15->setGeometry(QRect(720, 200, 31, 41));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        ...
        label_16->setGeometry(QRect(760, 209, 61, 31));
        ...
        label_4->setGeometry(QRect(560, 308, 80, 31));
        ...
        horizontalSlider->setGeometry(QRect(650, 312, 135, 20));
        ...
        label_5->setGeometry(QRect(790, 300, 20, 39));
    ...
    {
        ori_imageClass->setWindowTitle(QCoreApplication::translate("ori_imageClass", "Camera", nullptr));
        ...
        comboBox_2->setItemText(0, QCoreApplication::translate("ori_imageClass", "MER2-301-125-U3M-S DAHENG IMAGING", nullptr));
        comboBox_2->setItemText(1, QCoreApplication::translate("ori_imageClass", "\346\211\253\346\217\217\345\217\257\347\224\250\350\256\276\345\244\207", nullptr));
